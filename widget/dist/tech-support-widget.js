...
`, f = (t, r) => ({
  ...
  const l = {
    ...
    (i, o) => `${i ? `${i}&` : ""}${o}=${encodeURIComponent(`${l[o]}`)}`,
    ""
  );
  return `https://github.com/${t}/issues/new?${d}`;
};
class q extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const u = g.filter((n) => n.lang === e), s = h(e), c = f(r, e), a = this.attachShadow({ mode: "open" }), l = u.reduce(
      (n, p) => {
        const m = c({ ...p.headers, body: p.body });
        return `${n}
          <li>
    ...
    `;
    const d = a.querySelector(".open-btn"), i = a.querySelector(".close-btn"), o = a.querySelector(".menu");
    d.addEventListener("click", (n) => {
      n.preventDefault(), o.style.display = o.style.display === "flex" ? "none" : "flex";
    }), i.addEventListener("click", (n) => {
      n.preventDefault(), o.style.display = "none";
    });
  }
}
